...
def resolve_source_snapshot(self, dataset_id: str, snapshot_id: Optional[str], target_branch: str):
    """
    ...
    # Auto-discovery
    latest_snap = self.snapshot_dao.get_latest_snapshot(dataset_id, branch_name=target_branch)
    if not latest_snap:
